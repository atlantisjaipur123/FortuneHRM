        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card>
            <CardHeader className="flex justify-between items-center">
              ...
              <AddEmployeeDialog companyId={id} />
            </CardHeader>
            <CardContent>
              {employees.length > 0 ? (
...
function AddEmployeeDialog({ companyId }: { companyId: string }) {
  ...
  return (
    <>
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Add Employee to {getCompanyById(companyId)?.name || "Company"}</DialogTitle>
          </DialogHeader>
